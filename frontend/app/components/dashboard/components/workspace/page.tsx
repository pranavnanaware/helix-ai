...
const DEFAULT_SEQUENCE: Partial<Sequence> = {
    title: '',
    description: '',
    steps: [{
        step_title: '',
...
export const Workspace: React.FC<WorkspaceProps> = ({ 
    ...
    const [newSequence, setNewSequence] = useState<Partial<Sequence>>(DEFAULT_SEQUENCE);
    ...
    const handleCreateSequence = async () => {
        ...
        try {
            ...
            setIsCreating(false);
            setNewSequence(DEFAULT_SEQUENCE);
        } catch (error) {
                ...
                <div className="mt-8 space-y-4">
                    ...
                    {stepSequences.map((sequence) => (
                        <SequenceCard
                            ...
                            sequence={{
                                ...sequence,
                                status: sequence.status || 'defaultStatus',
